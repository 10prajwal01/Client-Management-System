...
public class UserController {
    ...
    public ResponseEntity<Users> createUsers(@RequestBody Users user) {
        try {
            Users _user = usersRepository.save(new Users(user.getUserName(), user.getUseremail(), user.getUserphonenumber(), user.getUserage(), user.getUserinfo(), user.getPassword()));
